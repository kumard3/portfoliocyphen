export default function Footer() {
    return (
<footer className="px-4 divide-y bg-logoback text-black">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a href="#" className="flex justify-center lg:justify-start">
				{/* <span className="self-center text-2xl font-semibold"></span> */}
				<img src="/cyphen-logo.png" alt="logo" className="w-60" />
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-coolGray-400">© 2022 Cyphen Innovations. All rights reserved.</div>
</footer>
    )
}