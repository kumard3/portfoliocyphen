export default function Footer() {
    return (
<footer className="px-4 divide-y bg-slate-700/20">
	...
	<div className="py-6 text-base text-center dark:text-coolGray-400">© 2022 Cyphen Innovations. All rights reserved.</div>
</footer>
    )
}