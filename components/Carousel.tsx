...
const data = [
  {
    ...
    href:`https://blog.cyphen.tech/`,
    img: "https://deepanshu.vercel.app/Group1.png",
  },
  {
    name: "DevUi",
  ...
  return (
    <section className="p-4 lg:p-8 " id="work">
      <div className="container mx-auto flex justify-center items-center my-[1rem]">
        <h1 className="text-4xl  text-center font-bold  max-w-3xl"> We are an Indian digital agency. We blend our enthusiasm for human-centered design with cutting-edge development tools. </h1>
      </div>
      <div className="container mx-auto space-y-3 mt-[10rem]">
